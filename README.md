# Hi 👋, I'm Muhammad Agung Ferdiansyah!
...
**Backend Development**  
Python, Golang, C++, Node.js, Express, Flask, FastAPI, PHP, Laravel, REST API, JWT, etc.
**Database & Cloud**  
MySQL, PostgreSQL, Supabase, Docker, Azure, DigitalOcean, etc.
**Machine Learning & IoT**  
TensorFlow, PyTorch, Scikit-learn, OpenCV, Pandas, C++, ESP32, Raspberry Pi, Arduino, etc.
<p align="left">
